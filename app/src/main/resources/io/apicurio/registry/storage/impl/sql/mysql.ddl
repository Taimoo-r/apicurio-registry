...
CREATE TABLE webhook_deliveries (
    ...
    CONSTRAINT FK_webhook_deliveries_1 FOREIGN KEY (subscriptionId) REFERENCES webhook_subscriptions(subscriptionId) ON DELETE CASCADE,
    CONSTRAINT UQ_webhook_deliveries_1 UNIQUE (subscriptionId, eventId)
) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
